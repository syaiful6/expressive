...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \App\ValidationPresenceVerifierInterface
     */
     ...
     *
     * @param  \Interop\ContainerInterface  $container
     * @return void
     */
    ...
    protected function callClassBasedExtension($callback, $parameters)
    {
        ...
        return call_user_func_array([$this->container->get($class), $method], $parameters);
    }
